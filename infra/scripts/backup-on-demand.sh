...
# Cloud SQL backup for all three instances plus an immediate run of the uploads bucket's
# scheduled Storage Transfer job, on top of (not instead of) their daily automatic backups.
#
